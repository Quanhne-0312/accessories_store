...
import CustomShippingAddressCard from './CustomShippingAddressCard';

function CustomSelectShippingAddressCard({ onChangeAddress }) {
...
export default CustomSelectShippingAddressCard;
